...
const {loading,isAuth} = useAppData();
  ...
  return (
   <nav className='bg-white shadow-md p-3 z-50'>
    <div className="px-[4px] flex justify-between items-center w-full">
...
<li>
    <Link href={"/blogs"} className='hover:text-blue-500'>Home</Link>
</li>
{isAuth &&<li>
...
{loading?"":<li>
   {isAuth?(
<Link href={"/profile"} className='hover:text-blue-500'><CircleUserRoundIcon/></Link>
   ):(
